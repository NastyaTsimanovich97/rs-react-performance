...
**Sorting by Population**
![Profile](profiling/perfom_sort_population.png)

- **Commit Duration:** 1.1s
- **Render Duration:** 3ms
- **Interactions:** Click on Sorting by Population.
- **Flame Graph:** [Flame Graph](profiling/perfom_sort_population.png).
- **Ranked Chart:** [Ranked Chart](profiling/perfom_sort_population_ranked.png).

**Filtering**
![Profile](profiling/perfom_filter.png)

- **Commit Duration:** 3.2s
- **Render Duration:** 0.9ms
- **Interactions:** Click on Filtering.
- **Flame Graph:** [Flame Graph](profiling/perfom_filter.png).
- **Ranked Chart:** [Ranked Chart](profiling/perfom_filter_ranked.png).
